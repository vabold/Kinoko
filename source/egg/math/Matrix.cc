...
/// @addr{0x805AE7B4}
/// @details Creates an orientation with
///   z axis: v0
///   Y axis: perp of v0-v1 plane
///   Z axis: perp to XY axes
void Matrix34f::makeOrthonormalBasis(const Vector3f &v0, const Vector3f &v1) {
    Vector3f x = v1.cross(v0);
    x.normalise();
    Vector3f y = v0.cross(x);
    y.normalise();
