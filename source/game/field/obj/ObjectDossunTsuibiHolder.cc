...
ObjectDossunTsuibiHolder::ObjectDossunTsuibiHolder(const System::MapdataGeoObj &params)
    : ObjectCollidable(params), m_stillTimer(params.setting(2)), m_facingBackwards(false),
      m_forwardVel(static_cast<f32>(params.setting(0))), m_stillDuration(params.setting(3)) {
