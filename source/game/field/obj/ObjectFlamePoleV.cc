...
ObjectFlamePoleV::ObjectFlamePoleV(const System::MapdataGeoObj &params)
    : ObjectCollidable(params), StateManager(this, STATE_ENTRIES), m_initDelay(params.setting(1)),
      m_cycleDuration(params.setting(0)), m_dormantFrames(params.setting(3) + 200),
