...
const std::array<StateManagerEntry<ObjectKuribo>, 4> StateManager<ObjectKuribo>::STATE_ENTRIES = {{
        {0, &ObjectKuribo::enterStateStub, &ObjectKuribo::calcState0},
        {1, &ObjectKuribo::enterStateStub, &ObjectKuribo::calcState1},
