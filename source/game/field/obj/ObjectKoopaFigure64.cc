...
void ObjectKoopaFigure64::calcCollisionTransform() {
    calcTransform();
    EGG::Matrix34f m1 = m_transform;
    m1.setBase(3, EGG::Vector3f::zero);

    EGG::Matrix34f m2 = EGG::Matrix34f::ident;
    m2.setBase(3, EGG::Vector3f(0.0f, -280.0f, 4000.0f));

    EGG::Matrix34f m3 = EGG::Matrix34f::ident;
    m3.setBase(3, m_pos);

    m_collision->transform(m3.multiplyTo(m1.multiplyTo(m2)), m_scale);
}
