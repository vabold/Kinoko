...
/// @brief Recalculate the bounds of all active units having @ref PermRecalcAABB or @ref TempRecalcAABB
/// flag, and then update the low and high points accordingly.
/// @addr{0x807859B0}
