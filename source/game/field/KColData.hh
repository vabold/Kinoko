...
public:
    ...
    [[nodiscard]] bool checkSphereCollision(f32 *distOut, EGG::Vector3f *fnrmOut,
            Attribute *flagsOut);
    [[nodiscard]] bool checkSphere(f32 *distOut, EGG::Vector3f *fnrmOut, Attribute *flagsOut);
    [[nodiscard]] bool checkSphereSingle(f32 *distOut, EGG::Vector3f *fnrmOut, Attribute *flagsOut);
...
private:
    ...
    [[nodiscard]] bool checkCollision(const KCollisionPrism &prism, f32 *distOut,
            EGG::Vector3f *fnrmOut, Attribute *flagsOut, CollisionCheckType type);
    ...
    [[nodiscard]] bool checkPointMovement(f32 *distOut, EGG::Vector3f *fnrmOut,
            Attribute *attributeOut);
    [[nodiscard]] bool checkPoint(f32 *distOut, EGG::Vector3f *fnrmOut, Attribute *attributeOut);
