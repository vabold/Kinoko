...
public:
    ...
    void setHalfPipeInvisibleWall(bool isSet);
    ...
    [[nodiscard]] bool isHalfPipeInvisibleWall() const;
...
private:
    ...
    bool m_bHalfPipeInvisibleWall;     ///< Colliding with both a zipper and invisible wall.
